              ...
              <div ref={chartSectionRef} className="space-y-6">
                <div className="bg-white rounded-2xl shadow-md p-3 md:p-6">
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-2 gap-2">
                    {/* Pie Chart */}
                    <div className="bg-white p-4 order-2 border rounded-xl hover:shadow-md">
                    ...
                    {/* Bar Chart */}
                    <div className="bg-white p-4 order-1 border rounded-xl hover:shadow-md">
                  ...
                  {/* Responsive Table */}
                  <div className="overflow-x-auto -mx-4 md:mx-0 pt-8">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="border-b">
                          <th className="p-2 md:p-4 text-xs md:text-sm font-bold text-[#0B2838]">CATEGORY</th>
                          <th className="p-2 md:p-4 text-xs md:text-sm font-bold text-[#0B2838]">TOTAL</th>
                          <th className="p-2 md:p-4 text-xs md:text-sm font-bold text-[#0B2838]"># OF EXPENSES</th>
                          <th className="p-2 md:p-4 text-xs md:text-sm font-bold text-[#0B2838]">AVERAGE</th>
                          <th className="p-2 md:p-4 text-xs md:text-sm font-bold text-[#0B2838]">VIEW</th>
                        </tr>
                      </thead>
                      <tbody>
