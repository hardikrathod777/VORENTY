...
const Insights = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#FFFAF3]">
      ...
      <div className="flex-1 p-2 md:p-4 mt-1">
        {isLoading ? (
          ...
          <>
            ...
            {!viewRawDataCategory && (
              <div ref={chartSectionRef}>
                <div className="flex-1 p-3 md:p-6 bg-white rounded-2xl shadow-md">
                  {/* Charts Container */}
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4 md:mb-6">
                    {/* Pie Chart */}
                    <div>
                      <h2 className="text-lg md:text-2xl font-bold mb-4 text-[#0B2838]">
                        Categories
                      </h2>
                      ...
                      <div className="bg-white rounded-xl shadow-sm">
                        <div className="p-6">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            ...
                            <div className="bg-slate-50 p-4 rounded-lg">
                              <div className="text-sm font-medium text-slate-600">Average/Month</div>
                              <div className="text-xl font-semibold text-slate-800 mt-1">
                                ₹{Math.round(monthlyData.data.reduce((a, b) => a + b, 0) / monthlyData.data.length).toLocaleString('en-IN')}
                              </div>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-lg">
                              <div className="text-sm font-medium text-slate-600">Highest Month</div>
                              <div className="text-xl font-semibold text-slate-800 mt-1">
                                ₹{Math.max(...monthlyData.data).toLocaleString('en-IN')}
                              </div>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-lg">
                              <div className="text-sm font-medium text-slate-600">Lowest Month</div>
                              <div className="text-xl font-semibold text-slate-800 mt-1">
                  ...
                  <div className="overflow-x-auto -mx-3 md:mx-0">
                    <div className="min-w-full">
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b text-[11px] md:text-sm text-[#0B2838] font-semibold">
                            <th className="p-2 md:p-3 whitespace-nowrap">CATEGORY</th>
                            <th className="p-2 md:p-3 whitespace-nowrap">TOTAL</th>
                            <th className="p-2 md:p-3 whitespace-nowrap "># OF EXPENSES</th>
                            <th className="p-2 md:p-3 whitespace-nowrap">AVERAGE</th>
                            <th className="p-2 md:p-3 whitespace-nowrap">VIEW</th>
                          </tr>
                        </thead>
                        <tbody>
