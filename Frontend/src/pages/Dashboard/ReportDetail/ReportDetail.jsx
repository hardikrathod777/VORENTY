...
function ReportDetail({ expenseData }) {
  ...
  const handleBackClick = () => {
    navigate("/reports"); // Update the path to match your "Reports" page route
  };
  ...
  const handleDelete = () => {
    ...
    setExpenses(updatedExpenses); // Update the table data

    // Set the selected expense to "PENDING"
    setSelectedExpense((prevState) => ({
      ...prevState,
      status: "PENDING", // Set status to "PENDING"
    }));

    // Add the expense to the list of pending expenses
