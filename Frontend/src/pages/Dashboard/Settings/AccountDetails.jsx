            ...
            <form className="grid grid-cols-1 gap-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="px-4 py-3 bg-gradient-to-r from-[#0B2838] to-[#1a4459] hover:from-[#1a4459] hover:to-[#0B2838] transition-all duration-300 ease-in-out transform hover:scale-[1.02] text-white rounded font-bold shadow "
                >
